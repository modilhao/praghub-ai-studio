...
export const Login: React.FC = () => {
    ...
    const fillCredentials = (role: 'admin' | 'company') => {
        if (role === 'admin') setEmail('admin@praghub.com');
        else setEmail('contato@fastclean.com.br');
    };
                    ...
                    <div className="bg-white dark:bg-card-dark rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 dark:border-input-border">
                        ...
                        <form onSubmit={handleLogin} className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="relative">
                                    <input className="w-full bg-gray-50 dark:bg-accent-dark text-gray-900 dark:text-white border border-gray-200 dark:border-input-border rounded-full h-12 pl-5 pr-12 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary placeholder:text-gray-400 dark:placeholder:text-text-secondary/50 transition-all" id="password" placeholder="********" type="password" defaultValue="password"/>
                            ...
                            <button className="w-full bg-primary hover:bg-primary-hover text-white font-bold text-base h-12 rounded-full mt-2 transition-all shadow-[0_4px_14px_0_rgba(0,118,255,0.39)] hover:shadow-[0_6px_20px_rgba(0,118,255,0.23)] flex items-center justify-center gap-2 group">
                                <span>Entrar</span>
