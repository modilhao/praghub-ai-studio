...
export const LandingConsumer: React.FC = () => {
    return (
        <div className="flex flex-col min-h-screen bg-background-dark">
                ...
                <div className="max-w-4xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-white mb-4">
                            ...
                            <span className="text-red-400">É contratar errado.</span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        {[
                            ...
                            <div key={i} className="bg-card-dark p-6 rounded-xl border border-card-border flex flex-col items-center text-center">
                    ...
                    <div className="bg-red-900/10 border border-red-900/30 rounded-xl p-6 text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-2">Busca objetiva</h3>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-2">Perfis claros e profissionais</h3>
                                    <p className="text-slate-400">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-2">Contato direto e rápido</h3>
                                    <p className="text-slate-400">
                        ...
                        <div className="bg-card-dark p-8 rounded-2xl shadow-xl border border-card-border relative">
            ...
            <section className="py-16 md:py-24 bg-background-dark">
                <div className="max-w-4xl mx-auto px-4">
                    <h2 className="text-3xl font-bold text-white mb-12 text-center">Para quem o PragHub foi criado</h2>
